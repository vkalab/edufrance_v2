...
playLocalAsset() async {
  audioPlayer = await audioCache.play('my_audio.mp3');
}
...
Future setAudio() async {
  ...
  final url = await player.load('lekce1.mp3');
...
/*
            Slider(
              ...
              onChanged: (value) async {
                ...
                await audioPlayer.play('https://soundcloud.com/iamhardstyle/brennan-heart-tony-junior-whats-up');
              },
            ),
 ...
 */
               ...
               Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          else Text(Controller1, style: const TextStyle(color: Colors.red,)), Text(" Je suis célibataire.")
                                        ],
                                      ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          else Text(Controller2, style: const TextStyle(color: Colors.red,)), Text(" Il a une souer.")
                                        ],
                                      ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          else Text(Controller3, style: const TextStyle(color: Colors.red,)), Text(" Vous êtes veuve.")
                                        ],
                                      ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          else Text(Controller4, style: const TextStyle(color: Colors.red,)), Text(" Ils sont amoureux")
                                        ],
                                      ),
                ...
                Row(
                    children: [
                      const SizedBox(width: 10,),
                      const Text("J’aime beaucoup faire le ménage."),
                      const SizedBox(width: 10,),
                      Flexible(
                        child: TextField(
            ...
            Row(
                    children: [
                      const SizedBox(width: 10,),
                      const Text("Il est amoureux de Jacquie."),
                      const SizedBox(width: 10,),
                      Flexible(
                        child: TextField(
                ...
                Row(
                    children: [
                      const SizedBox(width: 10,),
                      const Text("Vous avez le coup de foudre."),
                      const SizedBox(width: 10,),
                      Flexible(
                        child: TextField(
                ...
                Row(
                    children: [
                      const SizedBox(width: 10,),
                      const Text("Ils ont des enfants. "),
                      const SizedBox(width: 10,),
                      Flexible(
                        child: TextField(
