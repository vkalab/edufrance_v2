...
class _mluvnice1State extends State<mluvnice1> {
  List<String> tabulka1Fj = [
    ...
    "quitter qq",
    "être amoureux DE",
    "avoir le coup de foudre (pour qq)",
    "se marier avec/epouser qq",
    "reprocher qqch à qqn",
    "faire des compliments à qq",
    "la naissance",
    "les bébés",
    "l’enfance",
    "les enfants",
    ...
    "les adultes",
    "la retraite",
    "les personnes âgées/les vieux (hovorově)",
    "un vieux monsieur",
    "une vieille dame",
    "la mort",
    "le décès",
  ...
  List<String> tabulka4A = [
    "je suis (já jsem)",
    "tu es (ty jsi)",
    "il/elle/on est (on/ona/my je/jsme)"
  ];
  List<String> tabulka4B = [
    "nous sommes (my jsme)",
    "vous êtes (vy jste)",
    "Ils/elles sont (oni/ony jsou)"
  ];
  List<String> tabulka5A = [
    "j’ai (já mám)",
    "tu as (ty máš)",
    "il/elle/on a (on/ona/my má/máme)"
  ];
  List<String> tabulka5B = [
    "nous avons (my máme)",
    "vous avez (vy máte)",
    "Ils/elles ont (oni/ony mají)"
  ];
  List<String> tabulka6A = [
    "je fais (já dělám)",
    "tu fais (ty děláš)",
    "il/elle/on fait (on/ona/my dělá/děláme)"
  ];
  List<String> tabulka6B = [
  ...
  Widget build(BuildContext context) {
    double width50 = MediaQuery.of(context).size.width * 0.8;
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Mluvnice lekce 1',
          ...
          child: Center(
            child: Column(
              children: [
                ...
                const SizedBox(
                  //width: 360,
                  child: Text("Příklad: Je suis tchèque. - Jsem Čech.")
                ...
                Table(
                  ...
                  children: [
                    for (var i = 0; i < tabulka2Fj.length; i++)
                ...
                const SizedBox(
                    // width: 360,
                    child: Text(
                        "Užívají se pro zdůraznění (Toi, tu es tchèque. - Ty jsi Čech), po předložkách (Je ne veux pas y aller sans toi. – Bez tebe tam jít nechci.), po srovnávacích příslovcích (Tu n’es pas comme moi. – Nejsi jako já.).")
                    /*
                    RichText(text:const TextSpan(
                     children: [
                ...
                Table(
                  ...
                  defaultColumnWidth: const FixedColumnWidth(100.0),
                  children: [
                    for (var i = 0; i < tabulka3Fj.length; i++)
                      TableRow(children: <Widget>[
                        Text(
                          " " + tabulka3Fj[i],
                          style: const TextStyle(fontSize: 16),
                ...
                const SizedBox(
                  // width: 360,
                  child: Text(
                    "Vyjadřuje děj, který právě probíhá, obvyklý děj, zvyk, obecně platnou skutečnost a blízký budoucí děj.",
                  ),
                ),
                const SizedBox(
                  height: 15,
                ...
                const SizedBox(
                  //width: 360,
                  child: Text(
                    "Časování sloves être (být), avoir (mít) a faire (dělat):",
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
                ...
                Table(
                  border: TableBorder.symmetric(
                      outside: BorderSide(width: 2, color: Palette.kToDark)),
                  ...
                  children: [
                    ...
                    for (var i = 0; i < tabulka4A.length; i++)
                      TableRow(children: <Widget>[
                        SizedBox(
                          height: 40,
                          child: Text(
                ...
                Table(
                  ...
                  children: [
                    ...
                    for (var i = 0; i < tabulka5A.length; i++)
                      TableRow(children: <Widget>[
                        SizedBox(
                          height: 40,
                          child: Text(
                ...
                Table(
                  ...
                  //border: TableBorder(symetric: BorderSide(width: 0.5, color: Palette.kToDark, style: BorderStyle.solid)),
                  ...
                  children: [
                    ...
                    for (var i = 0; i < tabulka6A.length; i++)
                      TableRow(children: <Widget>[
                        SizedBox(
                          height: 40,
                          child: Text(
                ...
                const SizedBox(
                    width: 360,
                    child: Text(
                      "Tvoříme ho pomocí dvojice záporek ne…pas. V přítomném čase se umisťují záporky následovně: Je ne suis pas tchèque. Záporky jsou umístěny před a za slovesem.",
